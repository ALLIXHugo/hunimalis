...
<div class="main-wrapper">
    <div class="auth-card">
        ...
        <h2 class="form-title">Vérification Téléphone</h2>
        ...
        <p class="info-text">
            Un code SMS a été envoyé au numéro <strong>{{ $professionnel->telpro }}</strong>.<br>
            Veuillez le saisir ci-dessous pour valider votre compte.
        </p>

        <form method="POST" action="{{ route('professionnel.verifCodeSMS') }}">
            @csrf
            ...
            <div class="code-container">
                <input type="text" name="code" class="code-input-visual" maxlength="6" placeholder="------" value="{{ old('code') }}" required>
            </div>

            <button type="submit" class="btn-submit">Vérifier le téléphone</button>
        </form>
    </div>
</div>
@endsection